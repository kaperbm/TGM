 ...
 * In der Version: "3-Version" wurden Methoden für das Kopieren der Arrays hinzugefuegt
 * In der Version: "4-Version" wurden Methoden zur verkleinerung sowie vergrößerung eines Arrays hinzugefuegt
...
public class ArrayMethoden {
	 ...
	 * @return gibt das kopierte Array zurück
	 */
	 ...
	 */
		...
		/**
		 * Vergrößert das Array um den rübergegebenen Parameter
		 * @param array ist das Array welches vergrößert werden soll
		 * @param add ist die Größe um die das Array vergrößert werden soll
		 * @return gibt das vergrößerte Array zurück
		 */
     ...
     * @param add ist die Größe um die das Array verkleinert werden soll
     * @return gibt das verkleinerte Array zurück
     */
