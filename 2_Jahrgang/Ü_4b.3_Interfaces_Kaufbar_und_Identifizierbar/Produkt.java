...
public class Produkt implements Kaufbar,  Identifizierbar {
	...
	public double gesamtPreis(int stueckZahl)throws NumericRangeException {
		if(stueckZahl >=0) {
			...
			throw new NumericRangeException("Es darf keine negative Anzahl an Stücken rübergegeben werden");	// Die Exception wird geworfen falls der Parameter im negativen Bereich ist
		}
	}
