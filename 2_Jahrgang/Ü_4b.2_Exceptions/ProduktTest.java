...
public class ProduktTest {
	...
	public static void main(String[]args) throws NumericRangeException {
		...
		// Produkt p4 = new Produkt(2005, "Buch", "Ein fantasy Buch", 4.50);		
		/*
		 * Hier kann ein Test ausgeführt werden ob die Exceptions funktionieren in der Klasse Produkt
		 */
		...
		// ErweitertesProdukt pe4 = new ErweitertesProdukt(23223, "Kuli", "Ein Bleistift zum schreiben", 2.0 , -10); 	
		/*
		 * Hier kann ein Test ausgeführt werden ob die Exceptions funktionieren in der Klasse ErweitertesProdukt
		 */ 
